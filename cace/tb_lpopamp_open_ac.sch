...
C {devices/code_shown.sym} 80 -1110 0 0 {name=header only_toplevel=false value="
.param mc_mm_switch=0
.temp 25
"
}
C {devices/code_shown.sym} 1000 -1110 0 0 {name=control only_toplevel=false value="
.option gmin=1e-12
.option rshunt=1e12
.control
  * differential input
...
.endc
"}
C {devices/code_shown.sym} 780 -1110 0 0 {name=params only_toplevel=false value="
.param xavdd  = 3.3
.param xavss  = 0
.param xcm    = 1.65
.param xvin   = 0
